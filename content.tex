...
a figure that is genuinely consulted by name wants alphabetical order; and a figure that is only ever consulted by name wants to be a table (App.~\ref{sec-app-table}).
\end{box_red}
