...
\begin{table}[ht]
	...
	\begin{subtable}[t]{\textwidth}
		...
		\begin{tabular}{lrrrr}
			...
			\midrule
			\textit{Tree ensembles} & & & & \\
			\tabindent Gradient boosting & 0.86 & 0.89 & 0.84 & 0.88 \\
			\tabindent Random forest & 0.83 & 0.87 & 0.81 & 0.86 \\
			\addlinespace
			\textit{Neural} & & & & \\
			\tabindent MLP & 0.80 & 0.85 & 0.79 & 0.84 \\
			\addlinespace
			\textit{Classical} & & & & \\
			\tabindent SVM & 0.79 & 0.84 & 0.78 & 0.83 \\
			\tabindent k-NN & 0.74 & 0.80 & 0.72 & 0.79 \\
			\tabindent Ridge & 0.71 & 0.78 & 0.70 & 0.77 \\
			\bottomrule
		\end{tabular}
	\end{subtable}
\end{table}
